...
*/
	bool isInst(){return type_line()==t_Line::Instr;};

/**	\brief	tests if the line is a label
*/
	bool isLabel(){return type_line()==t_Line::Label;};

/**	\brief	tests if the line is a directive
*/
	bool isDirective(){return type_line()==t_Line::Directive;};
...
/** \brief display the content of the Line 
*/
	void display(){
