...
/**	\brief	Get the number in the Register name
...
/**	\brief	returns the OPRegister associated to the Operand if it is an OPRegister, otherwise returns nullptr*/
