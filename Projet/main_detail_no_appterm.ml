		...
		let rec run prog=
			let courant = List.nth prog !pc in
				...
				|{label;instr="CONST";args} -> print_triplet courant;
																			 ...
																			 if ((List.length !stack) > !taille) then taille:=(List.length !stack);
																			 print_string "\t-> taille=";print_int !taille;print_string " pc=";print_int !pc;print_string " accu=";print_mlvalue !accu;print_string " stack=[";print_list_aux !stack;print_string "] env=";print_mlvalue !env;print_string " extra_args="; print_int !extra_args;print_string " trap_sp="; print_int !trap_sp;print_newline ();
																			 run prog
